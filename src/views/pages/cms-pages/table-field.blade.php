...
<tr class="sortable-row position-relative field">
	<td class="text-center">
		...
		<input class="form-control" name="name[]" value="{{ $row_field_name }}">
	</td>
	<td class="text-center">
		<select class="form-control regular-select" name="migration_type[]">
			<option></option>
	...
	<td class="text-center">
		<select class="form-control regular-select" name="form_field[]">
			<option></option>
