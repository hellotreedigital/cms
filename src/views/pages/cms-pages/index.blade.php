...
@section('dashboard-content')
	...
	<div class="card py-4 mx-2 mx-lg-5">
		<div class="actions">
			...
			<form method="post" action="{{ url(config('hellotree.cms_route_prefix') . '/cms-pages/') }}" class="d-block d-md-inline-block bulk-delete" onsubmit="return confirm('Are you sure?')">
				@csrf
