			...
			<div class="form-group m-0">
				<label class="m-0">
					<ul>
						...
						<li>Display name is the name you see in create, edit and show pages.</li>
						<li>Display name plural is the name you see in the menu and in the browse pages.</li>
						<li>Icon is the class of a font-awesome icons, you will see the icon in the menu <a href="{{ url(config('hellotree.cms_route_prefix') . '/cms-pages/icons') }}" target="_blank" class="text-secondary">click here to see all icons.</a></li>
						<li>If you want to add drag and drop ordering to your table, write down the the column that you want to see whie ordering `Order display column`. Column must be added in the fields table. Then the CMS will automatically generate `ht_pos` column containg the row position.</li>
						...
						<li>Single record page will not have browse, create and delete. This page is used for generated table with one row only.</li>
