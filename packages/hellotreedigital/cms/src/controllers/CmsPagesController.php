...
class CmsPagesController extends Controller
{
	...
	{
		$rows = CmsPage::all();
		return view('cms::cms/pages/cms-pages/index', compact('rows'));
	}

	public function create()
	{
		return view('cms::cms/pages/cms-pages/create', [
	...
	public function edit($id)
	{
		...
		return view('cms::cms/pages/cms-pages/create', compact(
			'cms_page',
			'migration_types',
			'form_fields'
		));
...
';
    ...
    public function orderSubmit(Request $request)
    {
		...
		file_put_contents(
			...
			str_replace(
				...
				file_get_contents(base_path('vendor/hellotreedigital/cms/src/stubs/controller.stub'))
			)
		);
	}
	...
	public function generateMigration($database_table, $model_name_plural, $fields, $migration_name, $order_column)
	{
		...
		file_put_contents(
			...
			str_replace(
				...
				[$database_table, $model_name_plural, $columns],
				file_get_contents(base_path('vendor/hellotreedigital/cms/src/stubs/migration.stub'))
			)
		);
	...
	{
		if (!file_exists(resource_path('views/cms'))) mkdir(resource_path('views/cms'));
		if (!file_exists(resource_path('views/cms/pages'))) mkdir(resource_path('views/cms/pages'));
		...
		file_put_contents(
			...
			str_replace(
				...
				[$display_name_plural, $route, $add_button, $order_button, $bulk_delete_button, $table_header, $table_body],
				file_get_contents(base_path('vendor/hellotreedigital/cms/src/stubs/views/index.stub'))
			)
		);
	}
	...
	public function generateCreateView($route, $fields, $display_name_plural, $display_name, $order_column, $additional_cms_pages)
	{
		...
		foreach ($fields as $key => $field) {
			if ($field['form_field'] == 'textarea') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/textarea', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : '' ])
			";
			} elseif ($field['form_field'] == 'rich-textbox') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/rich-textbox', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : '' ])
			";
			} elseif ($field['form_field'] == 'select') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/select', ['label' => '" . ucwords(str_replace(['_id', '_'], ['', ' '], $field['name'])) . "', 'name' => '" . $field['name'] . "', 'options' => $" . $field['form_field_additionals_1'] . ", 'store_column' => 'id' , 'display_column' => '" . $field['form_field_additionals_2'] . "' ])
			";
			} elseif ($field['form_field'] == 'file') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/file', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "' ])
			";
			} elseif ($field['form_field'] == 'image') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/image', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "' ])
			";
			} elseif ($field['form_field'] == 'slug') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/input', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'slug_origin' => '" . $field['form_field_additionals_1'] . "', 'type' => 'text', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : '' ])
			";
			} elseif ($field['form_field'] == 'date') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/date', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ])
			";
			} elseif ($field['form_field'] == 'time') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/time', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ])
			";
			} elseif ($field['form_field'] == 'password') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/input', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'type' => 'password', 'value' => '' ])
			";
			} elseif ($field['form_field'] == 'password with confirmation') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/password-with-confirmation', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "' ])
			";
			} elseif ($field['form_field'] == 'checkbox') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/checkbox', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "' ])
			";
			} elseif ($field['form_field'] == 'map coordinates') {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/map', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ])
			";
			} else {
				$create_form_inputs .= "@include('cms::cms//components/form-fields/input', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'type' => 'text', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : '' ])
			";
			}
		}
		...
		file_put_contents(
			...
			str_replace(
				...
				file_get_contents(base_path('vendor/hellotreedigital/cms/src/stubs/views/create.stub'))
			)
		);
	}
	...
	public function generateEditView($route, $fields, $display_name_plural, $display_name)
	{
		...
		foreach ($fields as $key => $field) {
			if ($field['form_field'] == 'textarea') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/textarea', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'rich-textbox') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/rich-textbox', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'select') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/select', ['label' => '" . ucwords(str_replace(['_id', '_'], ['', ' '], $field['name'])) . "', 'name' => '" . $field['name'] . "', 'options' => $" . $field['form_field_additionals_1'] . ", 'store_column' => 'id' , 'display_column' => '" . $field['form_field_additionals_2'] . "', 'value' => " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'file') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/file', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'image') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/image', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'slug') {
				if ($field['form_field_additionals_2'])
					$edit_form_inputs .= "@include('cms::cms//components/form-fields/input', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'slug_origin' => '" . $field['form_field_additionals_1'] . "', 'type' => 'text', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'date') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/date', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'time') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/time', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'password') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/input', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'type' => 'password', 'value' => '' ])
			";
			} elseif ($field['form_field'] == 'password with confirmation') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/password-with-confirmation', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "' ])
			";
			} elseif ($field['form_field'] == 'checkbox') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/checkbox', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'checked' => " . '$' . "row->" . $field['name'] . " ])
			";
			} elseif ($field['form_field'] == 'map coordinates') {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/map', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : " . '$' . "row['" . $field['name'] . "'] ])
			";
			} else {
				$edit_form_inputs .= "@include('cms::cms//components/form-fields/input', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'name' => '" . $field['name'] . "', 'type' => 'text', 'value' => old('" . $field['name'] . "') ? old('" . $field['name'] . "') : " . '$' . "row->" . $field['name'] . " ])
			";
			}
		}
		...
		file_put_contents(
			...
			str_replace(
				...
				file_get_contents(base_path('vendor/hellotreedigital/cms/src/stubs/views/edit.stub'))
			)
		);
	}
	...
	public function generateShowView($route, $fields, $display_name_plural, $display_name, $page_type)
	{
		...
		foreach ($fields as $field) {
			if ($field['form_field'] != 'password' && $field['form_field'] != 'password with confirmation') {
				if ($field['form_field'] == 'image') {
					$show_fields .= "@include('cms::cms//components/show-fields/image', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'image' => " . '$' . "row" . '[' . "'" . $field['name'] . "'" . ']' . "] )
		";
				} elseif ($field['form_field'] == 'file') {
					$show_fields .= "@include('cms::cms//components/show-fields/file', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'file' => " . '$' . "row" . '[' . "'" . $field['name'] . "'" . ']' . "] )
		";
				} elseif ($field['form_field'] == 'files') {
					$show_fields .= "@include('cms::cms//components/show-fields/files', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'files' => " . '$' . "row" . '[' . "'" . $field['name'] . "'" . ']' . "] )
		";
				} elseif ($field['form_field'] == 'select') {
					$show_fields .= "@include('cms::cms//components/show-fields/text', ['label' => '" . ucwords(str_replace(['_id', '_'], ['', ' '], $field['name'])) . "', 'text' => " . '$' . $field['form_field_additionals_1'] . '[$' . "row['" . $field['name'] . "'" . ']][' . "'" . $field['form_field_additionals_2'] . "']] )
		";
				} elseif ($field['form_field'] == 'checkbox') {
					$show_fields .= "@include('cms::cms//components/show-fields/boolean', ['label' => '" . ucwords(str_replace(['_id', '_'], ['', ' '], $field['name'])) . "', 'value' => " . '$' . "row" . '[' . "'" . $field['name'] . "'" . ']' . "] )
		";
				} elseif ($field['form_field'] == 'map coordinates') {
					$show_fields .= "@include('cms::cms//components/show-fields/map', ['label' => '" . ucwords(str_replace(['_id', '_'], ['', ' '], $field['name'])) . "', 'name' => '" . $field['name'] . "', 'value' => " . '$' . "row" . '[' . "'" . $field['name'] . "'" . ']' . "] )
		";
				} else {
					$show_fields .= "@include('cms::cms//components/show-fields/text', ['label' => '" . ucwords(str_replace('_', ' ', $field['name'])) . "', 'text' => " . '$' . "row" . '[' . "'" . $field['name'] . "'" . ']' . "] )
		";
				}
			}
		}
		...
		file_put_contents(
			...
			str_replace(
				...
				file_get_contents(base_path('vendor/hellotreedigital/cms/src/stubs/views/show.stub'))
			)
		);
	}
	...
	public function generateOrderView($route, $display_name_plural, $order_display_column, $order_display_form_field)
	{
		...
		file_put_contents(
			...
			str_replace(
				...
				file_get_contents(base_path('vendor/hellotreedigital/cms/src/stubs/views/order.stub'))
			)
		);
	}
    ...
    {
        return view('cms::cms/pages/cms-pages/order');
    }
    ...
    public function icons()
    {
    	...
    	return view('cms::cms/pages/cms-pages/icons', compact('icons'));
    }
}